...
<head>
    ...
    <link href="../template/kritik_saran_hapus.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-4">
        <h2>Hapus Kritik&Saran</h2>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $row['tanggapan'] ?></td>
                    <td>
                        <a href="../admin/delete_kritik_saran.php?id=<?= $row['id_kritiksaran'] ?>" class="btn btn-danger btn-sm">Hapus</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
