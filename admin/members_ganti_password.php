...
<head>
    ...
    <link href="../template/members_ganti_password.css" rel="stylesheet">
</head>
<body>
<div class="container py-4">
    <h2 class="text-center mb-4">Ganti Password Member</h2>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>                
                <a href="ganti_password_member.php?username=<?= $row['username'] ?>" class="btn btn-sm btn-warning">Ganti Password</a>
            </td>
        </tr>
        <?php endwhile; ?>
        </tbody>
