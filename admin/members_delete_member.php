...
<head>
    ...
    <link href="../template/members_delete_member.css" rel="stylesheet">
</head>
<body>
<div class="container py-4">
    <h2 class="text-center mb-4">Hapus Member</h2>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>                
                <a href="delete_member.php?id=<?= $row['id_member'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus member ini?');">Hapus Member</a>
            </td>
        </tr>
        <?php endwhile; ?>
        </tbody>
